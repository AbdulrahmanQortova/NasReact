// src/pages/Admin/components/EditLearningPathModal.jsx
import { useState, useEffect } from 'react';
import { useTranslation } from 'react-i18next';
import { learningPathService } from '../../../services/learningPathService';
import { courseService } from '../../../services/courseService';
import './EditLearningPathModal.css';

export default function EditLearningPathModal({ path, onClose, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await learningPathService.update(path.id, {
      ...
      setError(err.message || t('admin.learningPaths.updateError'));
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="edit-path-modal" onClick={(e) => e.stopPropagation()} dir={isRTL ? 'rtl' : 'ltr'}>
        <div className="modal-header">
          <h2>✏️ {t('admin.learningPaths.editTitle')}</h2>
